app.controller('ctrlIndo',function($scope) {
  ...
  $scope.pager.filterOptions = [{key:'abbr',text:'Abbreviation'},{key:'long_name',text:'Indonesia Status'}];
  $scope.pager.orderOptions = [{key:'abbr',text:'Abbreviation'},{key:'long_name',text:'Indonesia Status'}];
  ...
  $scope.newO = function() {
    $scope.target = null;
    $scope.modalTitle = "New Indonesia Status";
    $scope.o = {abbr:'',long_name:''};
    $("#modalEdit").modal('show');
  };
  $scope.edit = function(o) {
    $scope.target = o;
    $scope.modalTitle = "Edit Indonesia Status: " + o.long_name + '(' + o.abbr + ')';
