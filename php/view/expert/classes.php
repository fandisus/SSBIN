<?php
$pageTitle = "Taxonomy Classes";
$pageSubTitle = "Manage Classes";
include $template;
...
function htmlHead() { ?>
  ...
  <script src="/js/expert/classes.js"></script>
<?php }

function mainContent() { ?>
  <div class="row" ng-controller="ctrlClass">
    <div class="col-md-6">
      ...
      <table class="table table-bordered table-striped table-condensed table-responsive">
        ...
        <tbody>
          <tr ng-repeat="o in classes">
            <td><a ng-click="edit(o)">{{o.class}}</a></td>
          </tr>
        </tbody>
      </table>
            ...
            <div class="modal-body">
              <table>
                <tr>
                  <td>Class</td>
                  <td>
                    <input type="text" ng-model="o.class" class="form-control" list="catList"/>
                    <datalist id="catList"><option ng-repeat="c in classList" ng-change="oChanged()" value="{{c}}"></option></datalist>
                  </td>
                </tr>
              </table>
  ...
  <div id="init" style="display:none"><?php
    $init = new stdClass();
    $init->classes = \SSBIN\Classes::allWhere(" ORDER BY class", []);
