<?php
$pageTitle = "Taxonomy Families";
$pageSubTitle = "Manage Families";
include $template;
...
function htmlHead() { ?>
  ...
  <script src="/js/expert/families.js"></script>
  <script src="/jslib/mine/DirPaging2.js"></script>
<?php }

function mainContent() { ?>
  <div class="row" ng-controller="ctrlFamily">
    <div class="col-md-6">
      ...
      <table class="table table-bordered table-striped table-condensed table-responsive">
        ...
        <tbody>
          <tr ng-repeat="o in families">
            <td>{{$index + pager.startRecord()}}</td>
            <td><a ng-click="edit(o)">{{o.family}}</a></td>
          </tr>
        </tbody>
      </table>
            ...
            <div class="modal-body">
              <table>
                <tr>
                  <td>Familiy</td>
                  <td>
                    <input type="text" ng-model="o.family" class="form-control" list="catList"/>
                    <datalist id="catList"><option ng-repeat="c in familyList" ng-change="oChanged()" value="{{c}}"></option></datalist>
                  </td>
                </tr>
              </table>
  ...
  <div id="init" style="display:none"><?php
    $init = new stdClass();
    $init->families = \SSBIN\Families::allWhere(" ORDER BY family LIMIT 50", []);
    $init->totalItems = \SSBIN\Families::count();
