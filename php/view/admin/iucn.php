<?php
$pageTitle = "IUCN Status";
$pageSubTitle = "Manage IUCN Status";
include $template;
...
function htmlHead() { ?>
  ...
  <script src="/js/admin/iucn.js"></script>
  <script src="/jslib/mine/DirPaging2.js"></script>
<?php }

function mainContent() { ?>
  <div class="row" ng-controller="ctrlIUCN">
    <div class="col-md-6">
  ...
  <div id="init" style="display:none"><?php
    $init = new stdClass();
    $init->statuses = \SSBIN\IUCN_status::allWhere(" ORDER BY abbr LIMIT 50", []);
    $init->totalItems = \SSBIN\IUCN_status::count();
