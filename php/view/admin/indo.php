<?php
$pageTitle = "Indonesia Status";
$pageSubTitle = "Manage Indonesia Status";
include $template;
...
function htmlHead() { ?>
  ...
  <script src="/js/admin/indo.js"></script>
  <script src="/jslib/mine/DirPaging2.js"></script>
<?php }

function mainContent() { ?>
  <div class="row" ng-controller="ctrlIndo">
    <div class="col-md-6">
      ...
      <table class="table table-bordered table-striped table-condensed table-responsive">
        ...
        <tbody>
          <tr ng-repeat="o in statuses">
            <td>{{$index + pager.startRecord()}}</td>
            <td><a ng-click="edit(o)">{{o.abbr}}</a></td>
            <td><a ng-click="edit(o)">{{o.long_name}}</a></td>
          </tr>
        </tbody>
      </table>
  ...
  <div id="init" style="display:none"><?php
    $init = new stdClass();
    $init->statuses = \SSBIN\Indo_status::allWhere(" ORDER BY abbr LIMIT 50", []);
    $init->totalItems = \SSBIN\Indo_status::count();
